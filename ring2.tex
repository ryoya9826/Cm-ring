...
有限群については部分加群を正規部分群と読み替えることで同様の定義ができ，組成列についてはJordan--H\uml{o}lderの定理という大定理が知られている．全く同様のことが加群でも成り立つ．
...
準素分解の一意性については，極小素因子に対応する成分は一意的に定まることがわかる（後に見るように，極小でない素因子に対応する成分については一意性が言えない）．
\begin{thm}
